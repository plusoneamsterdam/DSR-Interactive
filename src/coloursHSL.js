...
// classic 
// base
swatchHSL[1][0][0] = [0, 0, 97];
// swatchHSL[1][0][0] = [24, 33, 97];
swatchHSL[1][0][1] = [0, 0, 0];
// colourful
swatchHSL[1][1][0] = [0, 0, 100];
swatchHSL[1][1][1] = [228, 28, 17]; // D
...
// inverse 
// base
swatchHSL[4][0][0] = [228, 28, 17]; // D
swatchHSL[4][0][1] = [0, 0, 100];
// colourful
swatchHSL[4][1][0] = [0, 0, 97];
swatchHSL[4][1][1] = [0, 0, 97];
swatchHSL[4][1][2] = [12, 71, 44]; // R
swatchHSL[4][1][3] = [48, 81, 59]; // Y
swatchHSL[4][1][4] = [229, 38, 33]; // B 
// neutral
swatchHSL[4][2][0] = [228, 28, 17]; // D
swatchHSL[4][2][1] = [228, 28, 17]; // D
swatchHSL[4][2][2] = [30, 6, 87];
swatchHSL[4][2][3] = [0, 0, 83];
swatchHSL[4][2][4] = [0, 0, 83];